...
# todo: 1. автоматизированные перемещения, повороты, маштабирование: moveTo (target, time=, spd=, easing=, complete%=), stop(),
# todo: 2. состояния
# todo: 3. анимация:  скорость анимации множитель, события анимации, свойства кадрам анимации: обработчики, отправка событий
